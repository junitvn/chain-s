...
export type FieldType = 'text' | 'textarea' | 'number' | 'radio' | 'checkbox' | 'slider' | 'file' | 'date' | 'rich_text';
...
export type FormField = TextField | NumberField | SliderField | OptionsField | FileField | DateField | RichTextField;
